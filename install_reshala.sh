...
# ============================================================ #
# ==      ИНСТРУМЕНТ «РЕШАЛА» v0.302 dev - ВОЗВРАТ К ИСТОКАМ   ==
# ============================================================ #
# ==    Восстановлена база v0.299, исправлено определение версий. ==
# ============================================================ #

set -euo pipefail

# --- КОНСТАНТЫ И ПЕРЕМЕННЫЕ ---
readonly VERSION="v0.302 dev"
...
# --- УТИЛИТАРНЫЕ ФУНКЦИИ (ВОССТАНОВЛЕНЫ) ---
...
# --- IPv6 МОДУЛЬ (ВОССТАНОВЛЕН ИЗ v0.299) ---
check_ipv6_status() {
